...
const Hero = () => {
  ...
  return (
    <section className="relative pt-32 pb-20 overflow-hidden">
      {/* Background Blobs */}
      <div className="blob bg-indigo-100 w-96 h-96 rounded-full top-0 left-[-100px]"></div>
      <div className="blob bg-cyan-100 w-80 h-80 rounded-full bottom-0 right-[-50px]"></div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="relative h-[420px] bg-white rounded-xl shadow-2xl border border-slate-200 overflow-hidden ring-4 ring-slate-50/50 text-left transition-colors duration-300">
            ...
            <div className="h-full bg-white relative">
              ...
              {/* BEFORE VIEW */}
              {view === 'before' && (
                <div className="animate-in absolute inset-0 p-8 font-mono text-slate-800">
              ...
              {/* AFTER VIEW */}
              {view === 'after' && (
                <div className="animate-in absolute inset-0 bg-[#0F172A] text-slate-300 font-mono text-sm overflow-hidden flex flex-col">
    ...
    <footer className="bg-slate-50 border-t border-slate-200 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="pt-8 border-t border-slate-200 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-400">
          <p>© 2024 CodePromptMaker. All rights reserved.</p>
